<html>
	...
	<body style="background-color:yellow">
		...
		<h4>Total submitted report  <?echo $total?> </h4>
		<h4>Number of report pending<?echo $pending?> </h4>
		<h4>Number of report under processing  <?echo $processing?> </h4>
		<h4>Number of report has finished <?echo $finished?> </h4>
		<h4>Number of report has cancelled <?echo $canceled?> </h4>
