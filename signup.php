...
$mysqli->query("insert into login_info (username,password,type) values('$un','$ps',0)");
	...
	<body >
		<center>
			<h3>Registration</h3>
	    <form name="reg" method="POST" action="<?php $_SERVER['PHP_SELF'];?>">
        ...
        <br><br>
        Usernameame&nbsp;<input type="text" name="uname" id="un" onblur="unvalidate()">
        <span id="unp" style="color: red;"> <? if(isset($uerror)) echo $uerror;?> </span>
        <br><br>
        Enail&nbsp;<input type="email" name="email" id="em" onblur="emvalidate()">
        ...
        <span id="psp"></span>
        Retype Password&nbsp;<input type="password" name="rpass" id="rps">
